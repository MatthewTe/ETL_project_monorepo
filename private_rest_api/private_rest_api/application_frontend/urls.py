...
from .views import (
    ...
    create_article, render_developer_documentation, render_sipri_dashboard, render_api_dashboard, render_zotero_dashboard,
    about_me_homepage
    )

# Importing Plotly Dash apps to expose them to templates:
from .sipri_frontend.sipri_data_dashboards import app
from .noth_korea_frontend.nk_dashboards import image_app, nk_zotero_app

urlpatterns = [
    path("", render_homepage, name="homepage"),
    path("about_me", about_me_homepage, name="about_me"),
    ...
    path("paribus/dashboards/north_korea", render_north_korea_homepage, name="north_korea_homepage"),
    path("paribus/dashboards/zotero", render_zotero_dashboard, name="zotero_research_dashboard"),
